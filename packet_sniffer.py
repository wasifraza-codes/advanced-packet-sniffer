        ...
        if self.path == '/data':
            ...
            <head>
                ...
                <style>
                    ...
                    .packet { margin: 5px 0; padding: 8px; background: #f5f5f5; border-radius: 4px; font-family: monospace; font-size: 12px; }
            ...
            <body>
                ...
                <div class="panel">
                    ...
                    <div class="controls">
                        ...
                        <button class="btn-stop" onclick="control('stop_pcap')">Stop PCAP</button>
                        <button class="btn-clear" onclick="control('clear_alerts')">Clear Alerts</button>
